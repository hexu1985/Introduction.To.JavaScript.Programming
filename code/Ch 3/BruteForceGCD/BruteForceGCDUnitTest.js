...
function BruteForceGCDUnitTest() {
   ...
   if (JSUnitTest.getErrorCount() === 0) {
      console.println("BruteForceGCDUnitTest succeeded");
   } else {
      console.println("BruteForceGCDUnitTest failed");
   }
}
