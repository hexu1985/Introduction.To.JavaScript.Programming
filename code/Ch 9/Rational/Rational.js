 ...
 * integer by assigning a default value of 1.  The implementation ensures
 * that the following conditions hold for each rational number:
...
function Rational(num, den=1) {
   ...
   if (num === 0) {
      ...
      let g = Rational.gcd(Math.abs(num), den);
      num = num / g;
      den = den / g;
   }
