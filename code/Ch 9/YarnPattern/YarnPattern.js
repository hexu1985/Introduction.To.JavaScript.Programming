...
const PEG_SEP = 12;       /* The separation between pegs in pixels  */
const N_ACROSS = 80;      /* Number of PEG_SEP units horizontally   */
const N_DOWN = 50;        /* Number of PEG_SEP units vertically     */
const DELTA = 113;        /* Number of pegs to skip on each cycle   */
